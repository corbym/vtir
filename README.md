...
|---|--------|-----------|--------|
| 1 | Pro Tracker 3.xx | `.pt3` | ✅ Implemented |
| 2 | Pro Tracker 2.xx | `.pt2` | ✅ Implemented |
| 3 | Pro Tracker 1.xx | `.pt1` | ✅ Implemented |
...
| `pattern_play_arpeggio.json` | 54 ticks: 3-ch arpeggio + noise drum (ornament stepping, noise mixer path) |
