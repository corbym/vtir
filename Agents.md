...
> Functions already covered: `NoiseGenerator`, all 8 envelope shapes, `PT3_Vol` table, all 5 note tables, `Pattern_PlayCurrentLine` (basic, envelope, and arpeggio variants). All 8 Pascal baseline tests pass. See `PLAN.md §9` for the full status table.
